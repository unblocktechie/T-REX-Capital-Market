...
const organizations = [
  {
    ...
    activity: [
      ...
      { id: 'act-2', title: 'Wallet connected', description: 'Arc Testnet issuer wallet ownership confirmed.', at: isoDaysAgo(1, 9), tone: 'success' },
