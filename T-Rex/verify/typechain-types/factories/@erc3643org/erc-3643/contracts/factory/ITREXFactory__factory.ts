...
} from "../../../../../@erc3643org/erc-3643/contracts/factory/ITREXFactory";
...
export class ITREXFactory__factory {
  ...
  static createInterface(): ITREXFactoryInterface {
    return new Interface(_abi) as ITREXFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITREXFactory {
    return new Contract(address, _abi, runner) as unknown as ITREXFactory;
  }
}
