...
import type {
  ITREXGateway,
  ITREXGatewayInterface,
} from "../../../../../@erc3643org/erc-3643/contracts/factory/ITREXGateway";
...
export class ITREXGateway__factory {
  ...
  static createInterface(): ITREXGatewayInterface {
    return new Interface(_abi) as ITREXGatewayInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITREXGateway {
    return new Contract(address, _abi, runner) as unknown as ITREXGateway;
  }
}
