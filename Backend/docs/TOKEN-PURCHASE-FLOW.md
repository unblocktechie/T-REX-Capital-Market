...
This flow lets a registered investor pay in configured Arc Network USDC and receive the deployed
...
For Arc Network this project uses one confirmation. If mining exceeds the configured HTTP wait timeout,
