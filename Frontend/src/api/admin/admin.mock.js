...
const organizations = [
  {
    ...
    activity: [
      ...
      { id: 'act-2', title: 'Wallet connected', description: `${web3Config.requiredChain.name} issuer wallet ownership confirmed.`, at: isoDaysAgo(1, 9), tone: 'success' },
...
export const adminMockApi = {
  ...
  async downloadDocument(organizationId, documentId) {
    ...
    return {
      blob: new Blob([
        `${appConfig.name} development preview\n\nOrganization: ${organization.name}\nDocument: ${document.name}\nFile: ${document.fileName}\nStatus: ${document.status}\n`,
      ], { type: 'text/plain' }),
