...
import type {
  ...
  ITREXImplementationAuthorityInterface,
} from "../../../../../../@erc3643org/erc-3643/contracts/proxy/authority/ITREXImplementationAuthority";
...
export class ITREXImplementationAuthority__factory {
  static readonly abi = _abi;
  static createInterface(): ITREXImplementationAuthorityInterface {
    return new Interface(_abi) as ITREXImplementationAuthorityInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ITREXImplementationAuthority;
  }
}
