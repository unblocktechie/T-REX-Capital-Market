...
const mapWallet = (data) => {
  ...
  return {
    ...
    contractAddress: text(
      ...
      data?.organizationIdentityAddress,
      data?.organization_identity_address,
      data?.onchainIdentityAddress,
      data?.onchainIdAddress,
      data?.onchainIDAddress,
      data?.onChainId,
      data?.onchainId,
      data?.onchainid,
      ...
      data?.organizationWallet?.organizationIdentityAddress,
      data?.organizationWallet?.onchainIdentityAddress,
      data?.organizationWallet?.onchainIdAddress,
      data?.organizationWallet?.contractaddress,
      data?.wallet?.contractAddress,
      data?.wallet?.organizationIdentityAddress,
      data?.wallet?.onchainIdentityAddress,
      data?.wallet?.onchainIdAddress,
      data?.wallet?.contractaddress,
    ),
  };
};
